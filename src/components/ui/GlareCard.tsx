...
export const GlareCard = ({
  ...
  return (
    <div
      ...
      className="relative isolate [contain:layout_style] [perspective:600px] transition-transform duration-[var(--duration)] ease-[var(--easing)] delay-[var(--delay)] will-change-transform w-full min-h-[420px] cursor-pointer active:scale-[0.98] transition-all"
      ref={refElement}
      onClick={onClick}
      onPointerMove={(event) => {
